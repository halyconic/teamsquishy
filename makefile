...
p2_tr: all
	-cd test/requester && rm requester.txt
	@echo 'Run requester'
	cd test/requester && ../../requester/Default/requester -p 5050 -o filepart.txt -f mumble-13 -h 5000 -w 5 -d debug >> requester.txt
	@echo 'Done'
	
p2_ts: all
	-cd test/sender && rm sender.txt
	@echo 'Run sender'
	cd test/sender && ../../sender/Default/sender -p 5000 -g 5050 -r 1 -q 1 -l 8 -f mumble-13 -h 5050 -i 2 -t 5000 -d debug >> sender.txt
	@echo 'Done'
...
p2_1: all
	...
	-cd test/emulator && rm emulator.txt
	@echo 'Run sender'
	cd test/sender && ../../sender/Default/sender -p 2000 -g 4000 -r 100 -q 1 -l 100 -f mumble-13 -h 3001 -i 2 -t 100 -d debug >> sender.txt &
	@echo 'Run emulator'
...
p2_3:
	...
	-cd test/emulator && rm emulator.txt
	@echo 'Run sender'
	cd test/sender && ../../sender/Default/sender -p 2000 -g 4000 -r 100 -q 1 -l 100 -f mumble-13 -h 3000 -i 3 -t 100 -d debug >> sender.txt &
	@echo 'Run emulator'
	cd test/emulator && ../../emulator/Default/emulator -p 3000 -q 100 -f table3.txt -l log03 -d debug >> emulator.txt &
	sleep 1
	@echo 'Run requester'
	cd test/requester && ../../requester/Default/requester -p 4000 -f mumble-13 -h 3000 -o file.txt -w 10 -d debug >> requester.txt &
...
p2_4:
	...
	-cd test/emulator && rm emulator.txt
	@echo 'Run sender'
	cd test/sender && ../../sender/Default/sender -p 2000 -g 4000 -r 100 -q 1 -l 10 -f mumble-13 -h 3000 -i 3 -t 100 -d debug >> sender.txt &
	@echo 'Run emulator'
...
p2_5:
	...
	-cd test/emulator && rm emulator.txt
	@echo 'Run sender'
	cd test/sender && ../../sender/Default/sender -p 2000 -g 4000 -r 10 -q 1 -l 100 -f mumble-13 -h 3000 -i 2 -t 100 -d debug >> sender.txt &
	@echo 'Run emulator'
...
p2_6:
	...
	-cd test/emulator && rm emulator.txt
	@echo 'Run sender'
	cd test/sender && ../../sender/Default/sender -p 2000 -g 4000 -r 1 -q 1 -l 100 -f mumble-13 -h 3000 -i 3 -t 100 -d debug >> sender.txt &
	@echo 'Run emulator'
	cd test/emulator && ../../emulator/Default/emulator -p 3000 -q 100 -f table6.txt -l log06 -d debug >> emulator.txt &
	sleep 1
	@echo 'Run requester'
	cd test/requester && ../../requester/Default/requester -p 4000 -f mumble-13 -h 3000 -o file.txt -w 1 -d debug >> requester.txt &
